...
CLASSES = ['center']  # coco80类别

onnx_path = '../video/best.onnx'
...
class MeterDetection:
    ...
    def opencv_dnn(self):
        try:
            ...
            cv2.imwrite('../video/123.jpg', or_img)
    ...
    def Scalelines_Pointer(self):
        ...
        # cv2.imwrite('C:/Users/yang123/Desktop/video/45678.jpg', self.poniterMask)
        mask = np.zeros(img2.shape[0:2], np.uint8)
    ...
    def Center_of_Circle(self):
        ...
        # cv2.circle(self.image, (self.centerPoint[0], self.centerPoint[1]), 2, (0, 0, 255), 2)
    ...
    def Pointer_top(self):
        ...
        for line in lines:
            x1, y1, x2, y2 = line[0]
            # cv2.line(self.image, (x1, y1), (x2, y2),(0, 0, 255), 2, cv2.LINE_AA)
        ...
        cv2.line(self.image, (self.center_dnn[0], self.center_dnn[1]), (self.farPoint[0], self.farPoint[1]),(0, 0, 255), 2, cv2.LINE_AA)
        cv2.circle(self.image, (self.farPoint[0], self.farPoint[1]), 2, (0, 0, 255), 2)
        # cv_show('Pointer vertex', self.image)
    # ..............................找零刻度点.............................
    def Zero_scale(self):
        # 读取模板图片
        template = cv2.imread('../video/666.jpg')
        # 转换为灰度图片
